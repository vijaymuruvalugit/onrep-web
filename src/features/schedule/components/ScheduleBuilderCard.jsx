...
const BuilderFields = ({
  ...
  return (
    <div className="onrep-pattern-builder-fields">
      ...
      <div className="mt-3 d-flex justify-content-end">
        <CButton color="primary" size="sm" onClick={handleSubmit} disabled={saving || !days.length}>
  ...
  return (
    <CCard className="border-secondary-subtle shadow-none">
      <CCardHeader className="py-2 bg-body-secondary bg-opacity-10">
        <span className="small fw-semibold text-body-secondary">Edit weekly pattern</span>
      </CCardHeader>
