...
export default function ExerciseListPhaseView({
  activePhase,
  roster = [],
  entries = [],
  ...
  return (
    <section
      className="coach-live-phase-surface coach-live-phase-surface--guided"
      aria-label="Guided activities"
      data-testid="exercise-list-phase-view"
    >
      {defs.length ? (
